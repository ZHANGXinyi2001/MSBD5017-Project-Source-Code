...
import 'schema/notofication_record.dart';
...
export 'schema/notofication_record.dart';
...
/// Functions to query NotoficationRecords (as a Stream and as a Future).
Future<int> queryNotoficationRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      NotoficationRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<NotoficationRecord>> queryNotoficationRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      NotoficationRecord.collection,
      NotoficationRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<NotoficationRecord>> queryNotoficationRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
